...
public class FrmIniciarSesion extends javax.swing.JFrame {
    ...
    public FrmIniciarSesion() {
        initComponents();
        this.setSize(474, 633);
        this.setLocationRelativeTo(null);
        /*ImageIcon icono = new ImageIcon("src\\icono\\fondo_iniciar_sesion.jpg");
        JLabel fondo = new JLabel(icono);
        jPanel1.add(fondo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 474, 633));*/
        //jPanel1.add(new JLabel(new ImageIcon("src\\\\icono\\\\fondo_iniciar_sesion.jpg")), new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 474, 633));
        jLabel3.setIcon(new ImageIcon("src\\icono\\fondo_iniciar_sesion.jpg"));
    } 
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 470, 633));
        ...
        try {
            ...
            if (idPorCorreo == idPorClave && idPorCorreo != -1) {
                if (cbxRol.getSelectedItem().equals("ADMINISTRADOR")) {
                    int persona = rc.getCuentas().get(idPorCorreo - 1).getId_persona();
                    String nombres = ac.getAdministradores().get(persona - 1).getNombres();
                    String apellidos = ac.getAdministradores().get(persona - 1).getApellidos();
